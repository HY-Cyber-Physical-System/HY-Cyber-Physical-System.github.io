...
def research_cards():
    ...
    return ''.join(f'<article class="research-card"><div class="scene-mini" data-particles="{["wave","sphere","rings"][i]}" aria-hidden="true"><span class="scene-static">{["∿","◯","◎"][i]}</span><span class="scene-label">{["SYSTEM SOFTWARE","REAL-TIME COMPUTING","SERVER TECHNOLOGIES"][i]}</span></div><span class="research-number">0{i+1}</span><h3>{e(r["title"])}</h3><p>{summaries[i]}</p>{link("Explore research",r["path"])}</article>' for i,r in enumerate(D['research']))

cover=D['albums'][0]['cover']
body=f'''<section class="logo-story" aria-label="CPSLAB introduction"><div class="logo-stage" data-particles="logo"><div class="scene-topline"><span>Hanyang University<br>ERICA Campus</span><span>Cyber-Physical<br>Systems Laboratory</span></div><h1 class="logo-fallback">CPSLAB</h1><div class="scatter-message" aria-hidden="true"><p>Computing beyond<br>the screen.</p><p>Cyber-Physical Systems Laboratory</p></div><div class="wrap scene-bottom"><p class="scene-description"><strong>Cyber-Physical Systems Laboratory</strong>Connecting computing and the physical world.</p><div class="scroll-cue" aria-hidden="true"><span class="scroll-track"></span>Scroll to explore</div><a class="scene-link" href="#research">Explore the lab <span aria-hidden="true">↘</span></a></div></div></section><section class="hero"><div class="wrap hero-grid"><div class="hero-copy"><div class="eyebrow">Hanyang University · ERICA</div><h2>Cyber-Physical<br>Systems<br><span>Laboratory.</span></h2><p>Connecting computing and the physical world through systems research.</p><div class="hero-actions">{link('Explore our research','/research/','button')}{link('Meet the people','/members/')}</div></div><figure class="hero-photo">{img(cover,eager=True)}<figcaption class="photo-caption"><span>Life at CPSLAB</span><span>GRADUATION · 2025</span></figcaption></figure></div></section>
...
<section class="section" id="research"><div class="wrap"><div class="section-head"><div><div class="eyebrow">What we study</div><h2>Research areas</h2></div>{link('All research','/research/')}</div><div class="research-grid">{research_cards()}</div></div></section>
...
<section class="section contact-section" id="contact"><div class="contact-particles" data-particles="wave" aria-hidden="true"></div><div class="wrap contact-grid"><div><div class="eyebrow">Visit & contact</div><h2>Find us at<br>Hanyang ERICA.</h2></div><div><address><p>Room 622, ERICA Support Center<br>Hanyang University ERICA Campus<br>55, Hanyangdaehak-ro, Sangrok-gu, Ansan-si,<br>Gyeonggi-do, 15588, South Korea</p><p lang="ko">경기도 안산시 상록구 한양대학로 55<br>한양대학교 ERICA 학연산클러스터 지원센터 622호</p></address><div class="contact-meta"><a href="tel:+82314004748">+82 31 400 4748</a><a href="https://www.google.com/maps/search/?api=1&query=Hanyang+University+ERICA+Support+Center">View on map ↗</a></div></div></div></section>'''
